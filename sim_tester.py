...
from simulation_resources import SimulationRoutine, TemporaryConstantPowerLoadChange
...
c = TemporaryConstantPowerLoadChange(start_time=0.13, end_time=0.2, affected_node=la, new_Q=0.45)

sim = SimulationRoutine(n, 2, c, time_step=0.04)
